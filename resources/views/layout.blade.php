...
<body>
					...
					<div class="col-sm-4">
						<form action="{{URL::to('/search')}}" method="post">
							...
							<div class="search_box pull-right">
								<input type="text" name="keywords_submit" placeholder="Nhập nội dung tìm kiếm"/>
	...
	<div id="fb-root"></div>
	<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v17.0" nonce="XPRLfg5h"></script>
</body>
</html>